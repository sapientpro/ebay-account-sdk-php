...
**payment_policies** | [**\EBay\Account\Model\PaymentPolicy[]**](PaymentPolicy.md) | A list of all of the seller&#x27;s payment business policies defined for the specified marketplace. This array will be returned as empty if no payment business policies are defined for the specified marketplace. | [optional] 
