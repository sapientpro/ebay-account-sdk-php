...
> createOrReplaceSalesTax($body, $country_code, $jurisdiction_id)
...
$body = new \EBay\Account\Model\SalesTaxBase(); // \EBay\Account\Model\SalesTaxBase | A container that describes the how the sales tax is calculated.
...
try {
    $apiInstance->createOrReplaceSalesTax($body, $country_code, $jurisdiction_id);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **body** | [**\EBay\Account\Model\SalesTaxBase**](../Model/SalesTaxBase.md)| A container that describes the how the sales tax is calculated. |
...
# **getSalesTax**
> \EBay\Account\Model\SalesTax getSalesTax($country_code, $jurisdiction_id)
...
[**\EBay\Account\Model\SalesTax**](../Model/SalesTax.md)
...
# **getSalesTaxes**
> \EBay\Account\Model\SalesTaxes getSalesTaxes($country_code)
...
[**\EBay\Account\Model\SalesTaxes**](../Model/SalesTaxes.md)
