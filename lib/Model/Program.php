...
class Program implements ModelInterface, ArrayAccess
{
     ...
     * Sets program_type
     *
     * @param  string  $program_type  A seller program in to which a seller can opt-in. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:ProgramTypeEnum'>eBay API documentation</a>
     *
     * @return $this
     */
