...
class PaymentPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes
        = [
            ...
            'next'             => 'string',
            'offset'           => 'int',
            'payment_policies' => '\EBay\Account\Model\PaymentPolicy[]',
            'prev'             => 'string',
            'total'            => 'int',
        ];
     ...
     *
     * @param  PaymentPolicy[]  $payment_policies  A list of all of the seller's payment business policies defined for the specified marketplace. This array will be returned as empty if no payment business policies are defined for the specified marketplace.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param  int  $total  The total number of payment business policies retrieved in the result set.  <br/><br/>If no payment business policies are defined for the specified marketplace, this field is returned with a value of <code>0</code>.
     *
     * @return $this
     */
