...
class CategoryType implements ModelInterface, ArrayAccess
{
     ...
     * Sets default
     *
     * @param  bool  $default  <span class=\"tablenote\"><strong>Note:</strong> This field has been deprecated and is no longer used.<ul><li>Do not include this field in any <b>create</b> or <b>update</b> method.</li><li>This field may be returned within the payload of a <b>get</b> method, but it can be ignored.</li></ul></span>
     *
     * @return $this
     */
