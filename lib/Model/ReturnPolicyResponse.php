...
class ReturnPolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes
        = [
            ...
            'offset'          => 'int',
            'prev'            => 'string',
            'return_policies' => '\EBay\Account\Model\ReturnPolicy[]',
            'total'           => 'int',
        ];
     ...
     *
     * @param  ReturnPolicy[]  $return_policies  A list of all of the seller's return business policies defined for the specified marketplace. This array will be returned as empty if no return business policies are defined for the specified marketplace.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param  int  $total  The total number of return business policies retrieved in the result set.  <br/><br/>If no return business policies are defined for the specified marketplace, this field is returned with a value of <code>0</code>.
     *
     * @return $this
     */
