...
class Error implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes
        = [
            ...
            'parameters'     => '\EBay\Account\Model\ErrorParameter[]',
            'subdomain'      => 'string',
        ];
     ...
     * Sets domain
     *
     * @param  string  $domain  Name of the domain ,or primary system, of the service or application where the error occurred.
     *
     * @return $this
     */
     ...
     * Sets input_ref_ids
     *
     * @param  string[]  $input_ref_ids  Identifies specific request elements associated with the error, if any. inputRefId's response is format specific. For JSON, use <i>JSONPath</i> notation.
     *
     * @return $this
     */
     ...
     * Sets long_message
     *
     * @param  string  $long_message  A more detailed explanation of the error than given in the <code>message</code> error field.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param  string  $message  Information on how to correct the problem, in the end user's terms and language where applicable. Its value is at most 50 characters long. If applicable, the value is localized in the end user's requested locale.
     *
     * @return $this
     */
     ...
     * Sets output_ref_ids
     *
     * @param  string[]  $output_ref_ids  Identifies specific response elements associated with the error, if any. Path format is the same as <code>inputRefId</code>.
     *
     * @return $this
     */
     ...
     * Sets subdomain
     *
     * @param  string  $subdomain  If present, indicates the subsystem in which the error occurred.
     *
     * @return $this
     */
