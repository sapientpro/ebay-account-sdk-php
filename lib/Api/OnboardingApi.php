...
use EBay\Account\Model\PaymentsProgramOnboardingResponse;
...
class OnboardingApi
{
     ...
     * @param  string  $payments_program_type  The type of payments program whose status is returned by the method. (required)
     *
     * @return array of \EBay\Account\Model\PaymentsProgramOnboardingResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws InvalidArgumentException
     * @throws ApiException on non-2xx response
     */
    public function getPaymentsProgramOnboardingWithHttpInfo($marketplace_id, $payments_program_type)
    {
        $returnType = '\EBay\Account\Model\PaymentsProgramOnboardingResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EBay\Account\Model\PaymentsProgramOnboardingResponse',
     ...
     * @throws InvalidArgumentException
     */
    protected function getPaymentsProgramOnboardingRequest($marketplace_id, $payments_program_type)
    {
