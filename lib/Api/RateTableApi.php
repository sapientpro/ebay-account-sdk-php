...
use EBay\Account\Model\RateTableResponse;
...
class RateTableApi
{
    ...
    {
        [$response] = $this->getRateTablesWithHttpInfo($country_code);
     ...
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return array of \EBay\Account\Model\RateTableResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRateTablesWithHttpInfo($country_code = null)
    {
        $returnType = '\EBay\Account\Model\RateTableResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EBay\Account\Model\RateTableResponse',
